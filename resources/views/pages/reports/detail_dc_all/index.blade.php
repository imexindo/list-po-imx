...
<title>LIST SEWA | Laporan All | SPK</title>
...
@section('content')
    <div class="page-content">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <input type="hidden" id="contacts_id" value="{{ $data->first()->group_contract_id }}">
        ...
        <div class="row align-items-center">
            <div class="col-md-11">
                <div class="row">
                    <div class="col">
                        <button id="exportButtonReportAll" class="btn btn-primary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#exportButtonReportAll').on('click', function() {
                let contactsId = $('#contacts_id').val();
                let regionId = $('#region_id').val();
                let from = $('#from').val();
                let to = $('#to').val();

                let url = `/reports/details/all/${contactsId}/${regionId}/export`;
