...
<title>LIST SEWA | Laporan Non Toko</title>
                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Non Toko</li>
                        </ol>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            $(document).ready(function() {
                ...
                $('#exportButtonReport').on('click', function() {
                    ...
                    if (from && to) {
                        window.location.href = `/reports/export-report/non?from=${from}&to=${to}`;
                    } else {
                        Swal.fire({
                            title: 'Opps!',
                ...
                $('#FilterButtonReport').on('click', function() {
                    ...
                    window.location.href = `/reports/report/non-toko?from=${from}&to=${to}`;
                });

                $('#refresh').on('click', function() {
                    window.location.href = `/reports/report/non-toko`;
                });
                ...
                $('#typeContractTable tbody').on('click', '.btn-view-contract', function() {
                    ...
                    if (row.child.isShown()) {
                        ...
                        $.ajax({
                            url: `/reports/details/non-toko/${reportId}?from=${from}&to=${to}`,
                            method: 'GET',
                                ...
                                $('#details-' + reportId).html(data.map((item, index) => `
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button 
                                                class="btn btn-sm btn-primary btn-detail-non-toko" 
                            ...
                            error: function() {
                                $('#details-' + reportId).html(
                                    '<tr><td colspan="18" class="text-center">Gagal memuat detail</td></tr>'
                                    );
                            },
                            complete: function() {
                                Swal.close();
                ...
                // Klik tombol detail
                $(document).on('click', '.btn-detail-non-toko', function() {
                    ...
                    let url =
                        `/reports/details/non-toko/${contactsId}/${regionId}?from=${from}&to=${to}`;
                 ...
                 $(document).on('click', '.btn-export-contract', async function(e) {
                    ...
                    try {
                        const response = await fetch(
                            `/reports/details/export/non-toko/${contractId}/contract?from=${from}&to=${to}`);
