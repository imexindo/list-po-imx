...
<title>LIST SEWA | Laporan Non Toko | SPK</title>
...
@section('content')
    <div class="page-content">
        ...
        <div class="row align-items-center">
            <div class="col-md-11">
                <div class="row">
                    <div class="col">
                        <button id="exportButtonReportDcNon" class="btn btn-primary">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#exportButtonReportDcNon').on('click', function() {
                let contactsId = $('#contacts_id').val();
                let regionId = $('#region_id').val();
                let from = $('#from').val();
                let to = $('#to').val();

                let url = `/reports/details/non-toko/${contactsId}/${regionId}/export`;
