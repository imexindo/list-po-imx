                    ...
                    <tbody>
                        @foreach ($reports as $index => $report)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <button class="btn btn-sm btn-primary" data-id="{{ $report->contract->id }}">
                                        <i class="fa fa-eye"></i>
                                    </button>
                                </td>
            ...
            $(document).ready(function() {
                ...
                $('#typeContractTable tbody').on('click', 'button', function () {
                    ...
                    if (row.child.isShown()) {
                        ...
                        $.ajax({
                            url: `/reports/details/non-toko/${reportId}`,
                            method: 'GET',
                            ...
                            error: function() {
                                $('#details-' + reportId).html('<tr><td colspan="18" class="text-center">Gagal memuat detail</td></tr>');
                            },
                            complete: function() {
                                Swal.close();
                            }
