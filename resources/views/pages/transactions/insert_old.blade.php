                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="display: flex; align-items: center; justify-content: space-between;">
                                    ...
                                    <input type="checkbox" id="selectAllCheckbox" class="form-check-input" style="width: 27px; height: 27px; border: 1px solid #333;" />
                                </th>
                                ...
                                {{-- <th><span class="badge bg-primary">KF-00</span></th> --}}
                            ...
                            <div class="col-2">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        <input class="form-check-input" type="checkbox" role="switch" id="tagihans" name="tagihan" value="1" style="height: 25px; width: 60px; margin-right: 10px;">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-2">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="tgl_habis_sewa" name="tgl_habis_sewa">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="mb-2">
                            ...
                            <div class="col">
                                <div class="form-group">
                                  ...
                                  <a id="filePath" href="#" target="_blank" style="display: none;">Lihat File</a>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-2">
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <textarea name="keterangan" id="keterangan" cols="10" rows="10" class="form-control" placeholder="Berikan Keterangan"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $(document).ready(function() {
                ...
                $('#contractTable').on('click', '.edit-btn', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#Total_PK').val(new Intl.NumberFormat('id-ID', { minimumFractionDigits: 0, maximumFractionDigits: 0 }).format(data.total_pk));
                            ...
                            if (data.files) {
                                ...
                                $('#filePath').attr('href', fileUrl).text('Lihat File').show();
                            } else {
                                $('#filePath').hide();
                            }

                            $('#tgl_bap').val(new Date(data.tgl_bap).toLocaleDateString('id-ID', {day: '2-digit', month: '2-digit', year: 'numeric'}));
                            ...
                            $('#tagihanStatus').text(data.tagihan == 1 ? 'Aktif' : 'Non Aktif');

                            $('#editForm').attr('action', `{{ route('insert-contract.update', '') }}/${id}`);
                ...
                let table = $('#contractTable').DataTable({
                    ...
                    columnDefs: [
                        ...
                        { width: 100, className: 'text-center', targets: 5 },
                        { width: 150, className: 'text-center', targets: 6 },
                        { width: 450, targets: 7 },
                        { width: 100, className: 'text-center', targets: 8 },
                        { width: 110, className: 'text-center', targets: 9 },
                        { width: 150, className: 'text-center', targets: 10 },
                        { width: 150, className: 'text-center', targets: 11 },
                        { width: 100, targets: 12 },
                        { width: 200, targets: 13 },

                        { width: 200, targets: 14 },
                        { width: 150, className: 'text-center', targets: 15 },
                        // { width: 300, targets: 14 }, // Commented out duplicate target 14
                        { width: 150, targets: 16 },
                        { width: 350, targets: 17 },
                        { width: 10, className: 'text-center', targets: 18 },
                        { width: 50, className: 'text-center', targets: 19 },
                        { width: 250, targets: 20 },
                        { width: 10, targets: 21 },
                        { width: 350, targets: 22 },
                        { width: 60, className: 'text-center', targets: 23 },
                        { width: 60, className: 'text-center', targets: 24 },
                        { width: 60, className: 'text-center', targets: 25 },
                        { width: 60, className: 'text-center', targets: 26 },
                        { width: 60, className: 'text-center', targets: 27 },
                        { width: 60, className: 'text-center', targets: 28 },
                        { width: 60, className: 'text-center', targets: 29 },
                        { width: 60, className: 'text-center', targets: 30 },
                        { width: 60, className: 'text-center', targets: 31 },
                        { width: 60, className: 'text-center', targets: 32 },
                        { width: 60, className: 'text-center', targets: 33 },
                        { width: 60, className: 'text-center', targets: 34 },
                        { width: 60, className: 'text-center', targets: 35 },
                        { width: 60, className: 'text-center', targets: 36 },
                        { width: 60, className: 'text-center', targets: 37 },
                        { width: 60, className: 'text-center', targets: 38 },
                        { width: 60, className: 'text-center', targets: 39 },
                        { width: 400, className: 'text-left', targets: 40 },
                        { width: 400, targets: 41 },
                        { width: 200, className: 'text-center', targets: 42 },
                        { width: 200, className: 'text-center', targets: 43 }
                    ],
                    scrollX: true,
                    columns: [
                        {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                if (data) {
                                    ...
                                    return '<span class="badge bg-primary fw-light">'+ row.remaining_months + ' Bulan</span>';
                                }
                            }
                        },
                        {
...

                        {
                            data: 'tgl_cabut',
                            render: function(data) {
                                return data ? new Date(data).toLocaleString('id-ID', { year: 'numeric', month: '2-digit', day: '2-digit', }) : '-';
                            }
                        },
                        {
                        ...
                        {
                            data: 'created_at',
                            render: data => new Date(data).toLocaleString('id-ID', { year: 'numeric', month: '2-digit', day: '2-digit', hour: '2-digit', minute: '2-digit', second: '2-digit' })
                        },
                        {
                            data: 'updated_at',
                            render: function(data) {
               ...
               // Handle the 'Select All' checkbox
                $('#selectAllCheckbox').on('change', function() {
                    ...
                    $('#contractTable').find('input[type="checkbox"]').prop('checked', isChecked).trigger('change');
                });

                // Handle individual checkbox changes
                $('#contractTable').on('change', 'input[type="checkbox"]', function() {
                    var anyChecked = $('#contractTable').find('input[type="checkbox"]:checked').length > 0;
                    $('#updateButton').toggle(anyChecked);
                });

                // Handle the 'Update' button click
                $('#updateButton').on('click', function() {
                    var selectedIds = $('#contractTable').find('input[type="checkbox"]:checked').map(function() {
                        return $(this).data('id');
                    }).get();
                    ...
                    try {
                        ...
                        if (data.length > 0) {
                            ...
                            try {
                                ...
                                const editResponse = await fetch(`{{ url('/transactions/edit-contracts') }}/${kode}`, {
                                    method: 'GET',
                                    headers: {
                                        'Content-Type': 'application/json',
                                        'X-CSRF-TOKEN': csrfToken
                                ...
                                Swal.fire({
                                    ...
                                    text: 'Failed to fetch contract details: ' + editError.message,
                                    icon: 'error',
                                    confirmButtonText: 'OK'
                                });
                            }
