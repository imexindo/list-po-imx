    ...
    <div class="page-content">
        <div class="container-fluid">
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="/putus">Putus</a></li>
            ...
            <div class="card">
                ...
                <form action="{{ route('putus.update', ['id' => encrypt($getPo->id)]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                    ...
                    <div class="card-footer">
                        <a href="/putus" class="btn btn-secondary" >Kembali</a>
