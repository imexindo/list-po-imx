                                            ...
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-white">
                                                        ...
                                                        <h4 class="mt-4 fw-medium lh-base text-white">“Hard work and perseverance are the keys to achieving dreams. Every small step we take brings us closer to our goals. Never give up, as every effort will yield satisfying results.”</h4>
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                <div class="flex-shrink-0">
                                                                    <img src="{{ asset('cms/assets/img/logo.png') }}" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                </div>
