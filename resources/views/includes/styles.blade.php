...
<!-- plugin css -->
<link href="{{ asset('cms/assets/jquery-jvectormap-1.2.2.css') }}" rel="stylesheet" type="text/css">
<!-- preloader css -->
...
<link rel="stylesheet" href="{{ asset('cms/assets/jquery.dataTables.min.css') }}">
