...
<head>
    ...
    <!-- jQuery -->
    <script src="{{ asset('cms/js/jquery-3.7.1.min.js') }}"></script>

    <!-- DataTables CSS -->
    <link rel="stylesheet" href="{{ asset('cms/js/jquery.dataTables.min.css') }}">

    <!-- DataTables JS -->
    <script src="{{ asset('cms/js/jquery.dataTables.min.js') }}"></script>

</head>

<body class="pace-done class="{{ session('theme', 'light') }}">
