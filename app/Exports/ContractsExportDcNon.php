...
class ContractsExportDcNon implements FromCollection, WithHeadings, WithMapping, WithStyles
{
    ...
    public function __construct($contacts_id, $region_id, $from = null, $to = null)
    {
    ...
    public function collection()
    {
        $query = Contracts::with(['contract', 'type_contracts', 'region', 'category'])
            ...
            ->where('contract_id', $this->contacts_id)
            ->where('tagihan', 1)
