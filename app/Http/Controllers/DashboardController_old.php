...
class DashboardController extends Controller
{
    public function index() {
        ...
        $yearlyContractsLine = Contracts::select(DB::raw('SUM(total_pk) as total'), DB::raw('YEAR(tgl_bap) as year'))
        ...
        return view('pages.dashboard', compact('contracts', 'toko', 'contract', 'contractTipe', 'region', 'yearlyTotals', 'laporan', 'nonAktif', 'aktif', 'yearlyTotalsSpk', 'startYear', 'currentYear'));
    }
